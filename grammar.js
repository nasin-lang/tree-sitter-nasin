    ...
    rules: {
        ...
        bin_op: ($) =>
            choice(
                ...
                bin_op(PREC.BIT_OR, seq($.pipe, optional($._newline)), $.expr),
                bin_op(PREC.BIT_AND, seq($.ampersand, optional($._newline)), $.expr),
                bin_op(PREC.BIT_SHIFT, seq($.double_lt, optional($._newline)), $.expr),
                bin_op(PREC.BIT_SHIFT, seq($.double_gt, optional($._newline)), $.expr),
